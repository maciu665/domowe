...
def main():
    ...
    def find_json_for_file(file: Path):
        ...
        #tu dodac dokladna kopie sciezki
        #print("file", file )
        try:
            ...
            with json_file.open('r', encoding="utf-8") as f:
                ...
                _all_jsons_dict[file.parent][file.stem+'.json'] = json_dict
                return _all_jsons_dict[file.parent][file.stem+'.json']
        except:
        ...
        if file.parent in _all_jsons_dict and file.name in _all_jsons_dict[file.parent]:
            ...
            print("error 2", file.parent in _all_jsons_dict, file.name in _all_jsons_dict[file.parent])
            raise FileNotFoundError(f"Couldn't find json for file: {file}")
